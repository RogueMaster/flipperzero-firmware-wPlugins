...
bool GhoulsSettings::init(ViewDispatcher **view_dispatcher, void *appContext)
{
    ...
    if (!easy_flipper_set_variable_item_list(&variable_item_list, GhoulsViewSettings,
...
#ifndef FW_ORIGIN_Momentum
        return easy_flipper_set_uart_text_input(&text_input, GhoulsViewTextInput,
...
#else
        return easy_flipper_set_text_input(&text_input, GhoulsViewTextInput,
                                           "Enter SSID", text_input_temp_buffer.get(), text_input_buffer_size,
                                           textUpdatedSsidCallback, callbackToSettings, view_dispatcher_ref, this);
#endif
    }
