...
static void progress_view_draw_callback(Canvas* canvas, void* context) {
    ...
    elements_multiline_text_aligned(canvas, 64, SCENE_HEADER_POSITION_Y, AlignCenter, AlignTop, "Receiving via NFC...");
...
void nfc_share_scene_receive_on_enter(void* context) {
    ...
    dialog_ex_set_header(app->dialog_show_file, "Receiving via NFC...", 64, SCENE_HEADER_POSITION_Y, AlignCenter, AlignTop);
