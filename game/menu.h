...
void drawTitleScreen() {
    ...
    gfx_sprite_self_masked(
        9, 9, leftGuyLeftEye, blinkingEyesLeftGuy[blinkingFrames]);
    gfx_sprite_self_masked(
        15, 13, leftGuyRightEye, blinkingEyesLeftGuy[blinkingFrames]);
    gfx_sprite_self_masked(
        109, 34, rightGuyEyes, blinkingEyesRightGuy[blinkingFrames]);
}
