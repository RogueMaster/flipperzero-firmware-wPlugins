...
static void mf_settings_snapshot(MorseFlipperApp* app, MfSettingsSnapshot* snapshot) {
    *snapshot = (MfSettingsSnapshot){
        ...
        .farnsworth_wpm = app->trainer_farnsworth_wpm,
        .answer_timeout_s = app->trainer_answer_timeout_s,
        .group_pause_s = app->trainer_group_pause_s,
        .group_size = morse_trainer_group_size(&app->trainer),
        .group_count = morse_trainer_session_groups(&app->trainer),
        .custom_set_idx = app->trainer.custom_set_idx,
