...
enum { SR_SCAN_CTL_IDENT_MS = 1500 };
...
enum { SR_SCAN_CTL_QUAL_STALE_MS = 15000 };

static inline bool sr_scan_ctl_sd_dead(
    uint32_t qual_rev,
    uint8_t sd,
...
enum { SR_SCAN_CTL_IDENT_MAX_SENDS = 2 };
...
static inline bool sr_scan_ctl_ident_yields_state4(
    bool ident_overlay,
    bool sd_dead,
    bool sealing) {
