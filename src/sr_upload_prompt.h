...
static inline bool sr_upload_prompt_http_digits(
    const char* reason,
    const char** digits,
    size_t* n_out) {
    size_t i;
...
static inline void sr_upload_prompt_http_code_line(
    char* dst,
    size_t cap,
    const char* digits,
    size_t n) {
...
static inline bool sr_upload_prompt_fail_lines(
    const char* reason,
    const char** line1,
    const char** line2) {
    static const struct {
...
static inline void sr_upload_prompt_puts(SrUploadPrompt* out, const char* line1, const char* line2) {
