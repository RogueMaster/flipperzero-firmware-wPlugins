...
# IMPORTANT NOTE : This is a forked version of the RogueMaster CFW where the menus (Vertical, DSi, PS4...) are restored. There might be a delay after the official update release because of the time when seeing that. The official RogueMaster firmware page is [here](https://github.com/RogueMaster/flipperzero-firmware-wPlugins).
...
## Latest Updates - [PATREON: Latest Release RM0409-0025-0.420.0-11c872a](https://www.patreon.com/RogueMaster?filters[tag]=Latest%20Release)

- Last Synced/Checked OFW, changes in [commits](https://github.com/flipperdevices/flipperzero-firmware/commits/dev): `2026-04-09 00:25 EST`
- Last Synced/Checked Unleashed, changes in [changelog](https://github.com/RogueMaster/flipperzero-firmware-wPlugins/blob/420/CHANGELOG.md): `2026-04-09 00:25 EST`
...
- Added: [Access Audit v1.5 (By matthewkayne)](https://github.com/matthewkayne/flipper-access-audit)
- Added: [FlipIRFreq v0.2 (By jsammarco)](https://github.com/jsammarco/FlipIRFreq)
...
- Added: [MFP Reader v1.0 (By Defensor7)](https://github.com/Defensor7/flipperzero-mfp-reader)
- Updated: [Tesla Mod v2.6 (By hypery11)](https://github.com/hypery11/flipper-tesla-fsd)
...
- [Access Audit v1.8 (By matthewkayne)](https://github.com/matthewkayne/flipper-access-audit)
...
- [LAN Tester v2.4 (By dok2d)](https://github.com/dok2d/fz-W5500-lan-analyse)
...
- [Tesla Mod v2.6 (By hypery11)](https://github.com/hypery11/flipper-tesla-fsd)
