...
static int32_t nfc_tools_ndef_write_worker(void* context) {
    ...
    // Phase 4: read the Capability Container (page 3) to determine
    //          the user capacity of the tag.
    ...
    // Phase 5: write page by page starting from page 4
    //          The buffer is padded to a multiple of 4 bytes.
