...
void specter_scene_start_on_enter(void* context) {
    ...
    submenu_add_item(submenu, "Sweep - find it", StartIndexSweep, specter_scene_start_submenu_cb, app);
    submenu_add_item(
    ...
    submenu_add_item(submenu, "Logbook - findings", StartIndexLogbook, specter_scene_start_submenu_cb, app);
    submenu_add_item(
        submenu, "Settings", StartIndexSettings, specter_scene_start_submenu_cb, app);
    submenu_add_item(submenu, "Help & About", StartIndexAbout, specter_scene_start_submenu_cb, app);
