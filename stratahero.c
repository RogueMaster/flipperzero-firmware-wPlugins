...
static void stratahero_apply_orientation(StrataHeroApp* app, bool flipped) {
    ViewOrientation orientation = flipped ? ViewOrientationHorizontalFlip : ViewOrientationHorizontal;
    ...
    view_set_orientation(stratagem_types_widget_get_view(app->stratagem_types_widget), orientation);
    view_set_orientation(stratagem_list_widget_get_view(app->stratagems_list_widget), orientation);
    view_set_orientation(stratagem_detail_widget_get_view(app->stratagem_detail_widget), orientation);
    view_set_orientation(stratagem_train_widget_get_view(app->stratagem_train_widget), orientation);
    ...
    view_set_orientation(stratahero_settings_widget_get_confirmation_view(app->settings_widget), orientation);
...
static void stratahero_populate_highscores_widget(StrataHeroApp* app, bool is_quiz) {
    ...
    if (scores->count == 0) {
        ...
        for(int i = 0; i < scores->count; i++) {
            ...
            widget_add_string_element(widget, 4, 14 + i * 10, AlignLeft, AlignTop, FontSecondary, name_lines[i]);
            widget_add_string_element(widget, 124, 14 + i * 10, AlignRight, AlignTop, FontSecondary, score_lines[i]);
        }
    }
}
...
static void stratahero_show_highscores(StrataHeroApp* app, bool is_quiz) {
    ...
    HighScoreList* scores = is_quiz ? &app->quiz_scores : &app->game_scores;
    StrataHeroView view = is_quiz ? StrataHero_View_QuizHighscores : StrataHero_View_GameHighscores;
...
static void name_entry_callback(void* context) {
    ...
    stratahero_populate_highscores_widget(app, is_quiz);
    stratahero_switch_view(app, is_quiz ? StrataHero_View_QuizHighscores : StrataHero_View_GameHighscores);
}
...
StrataHeroApp* stratahero_app_alloc() {
    ...
    submenu_add_item(app->play_menu, "Highscores", PlayMenu_Highscores, play_menu_event_callback, app);
    ...
    submenu_add_item(app->quiz_menu, "Highscores", QuizMenu_Highscores, quiz_menu_event_callback, app);
    ...
    widget_add_string_element(app->game_about_widget, 64, 2, AlignCenter, AlignTop, FontPrimary, "Play Mode");
    widget_add_string_multiline_element(
        app->game_about_widget, 0, 16, AlignLeft, AlignTop, FontSecondary,
    ...
    widget_add_string_element(app->quiz_about_widget, 64, 2, AlignCenter, AlignTop, FontPrimary, "Quiz Mode");
    widget_add_string_multiline_element(
        app->quiz_about_widget, 0, 16, AlignLeft, AlignTop, FontSecondary,
    ...
    view_dispatcher_add_view(app->view_dispatcher, StrataHero_View_PlayMenu, submenu_get_view(app->play_menu));
    view_dispatcher_add_view(app->view_dispatcher, StrataHero_View_QuizMenu, submenu_get_view(app->quiz_menu));
    ...
    view_dispatcher_add_view(app->view_dispatcher, StrataHero_View_GameHighscores, widget_get_view(app->game_highscores_widget));
    view_dispatcher_add_view(app->view_dispatcher, StrataHero_View_QuizHighscores, widget_get_view(app->quiz_highscores_widget));
    view_dispatcher_add_view(app->view_dispatcher, StrataHero_View_GameAbout, widget_get_view(app->game_about_widget));
    view_dispatcher_add_view(app->view_dispatcher, StrataHero_View_QuizAbout, widget_get_view(app->quiz_about_widget));
    view_dispatcher_add_view(app->view_dispatcher, StrataHero_View_NameEntry, text_input_get_view(app->name_entry));
