...
void cancommander_scene_debug_menu_on_enter(void* context) {
    ...
    submenu_add_item(
        ...
        app);
    submenu_add_item(
        app->submenu, "Bus Config", DebugBusConfig, cancommander_scene_debug_menu_callback, app);
    submenu_add_item(
        app->submenu, "Bus Filters", DebugBusFilters, cancommander_scene_debug_menu_callback, app);
    submenu_add_item(
        app->submenu, "Stats", DebugStats, cancommander_scene_debug_menu_callback, app);
    submenu_add_item(app->submenu, "Ping", DebugPing, cancommander_scene_debug_menu_callback, app);
    submenu_add_item(
        app->submenu, "Get Info", DebugGetInfo, cancommander_scene_debug_menu_callback, app);
