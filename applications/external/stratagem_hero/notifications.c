...
void stratahero_code_glyph_entry_success_notification(
...
void stratahero_code_glyph_entry_failure_notification(
    NotificationApp* notification,
    const StrataHeroSettings* settings) {
    if(settings->sound_enabled && settings->vibro_enabled) {
...
void stratahero_stats_final_hit_notification(
    NotificationApp* notification,
    const StrataHeroSettings* settings) {
    if(settings->sound_enabled && settings->vibro_enabled) {
...
void stratahero_stats_hit_notification(
    NotificationApp* notification,
    const StrataHeroSettings* settings) {
    if(settings->sound_enabled && settings->vibro_enabled) {
...
void stratahero_code_complete_notification(
    NotificationApp* notification,
    const StrataHeroSettings* settings) {
    if(settings->sound_enabled && settings->vibro_enabled) {
