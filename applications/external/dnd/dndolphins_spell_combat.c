...
static bool
    pocket_parse_damage_dice(const char* text, uint8_t* dice, uint8_t* die, int16_t* flat_bonus) {
...
bool pocket_d20_spell_damage_spec(
    ...
    for(size_t index = 0U;
        index < sizeof(pocket_spell_damage_map) / sizeof(pocket_spell_damage_map[0]);
        ++index) {
        ...
        uint8_t multiplier = mapped->cantrip_scale ? pocket_cantrip_multiplier(character_level) :
                                                     1U;
    ...
    if(pocket_parse_damage_dice(
        ...
        output->resolution = (pocket_contains_ci(spell->detail, "save") ||
                              pocket_contains_ci(spell->detail, "dc")) ?
                                 PocketSpellResolutionSave :
                                 PocketSpellResolutionAttack;
