...
class FlipperLink:
    ...
    def start(self) -> None:
        ...
        self._thread = threading.Thread(
            target=self._run, name="flipper-link", daemon=True
        )
        self._thread.start()
    ...
    def _handle_json(self, line: str) -> None:
        ...
        frame = TpmsFrame(
            ...
            pressure_kpa=(
                (pressure / 100.0) if isinstance(pressure, (int, float)) else None
            ),
        ...
        self._emit(
            ...
            Reading(
                ...
                frame=frame,
                rssi_dbm=(
                    (rssi_x10 / 10.0) if isinstance(rssi_x10, (int, float)) else None
                ),
            ),
        )
