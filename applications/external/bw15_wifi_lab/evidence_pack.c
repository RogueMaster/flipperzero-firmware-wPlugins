...
G5EvidenceResult
    g5_evidence_commit_buffer(G5EvidenceWriter* writer, const uint8_t* data, size_t length) {
...
const char* g5_evidence_result_name(G5EvidenceResult result) {
    ...
    case G5EvidenceOk:
        return "ok";
    case G5EvidenceInvalidArgument:
        return "invalid_argument";
    case G5EvidenceWriteFailed:
        return "write_failed";
    case G5EvidenceSyncFailed:
        return "sync_failed";
    case G5EvidenceCloseFailed:
        return "close_failed";
    case G5EvidenceCommitFailed:
