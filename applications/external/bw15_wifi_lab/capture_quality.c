...
static G5CqIngestResult parse_frame(const uint8_t* frame, size_t length, G5CqParsed* parsed) {
    ...
    if(message <= 3 && bytes_invalid_secret(parsed->record.nonce, 32)) return G5CqIngestBadNonce;
    if(message == 1) {
...
const char* g5_cq_result_name(G5CqResult result) {
    ...
    case G5CqResultValidM1M2:
        return "valid_m1_m2";
    case G5CqResultValidM2M3:
        return "valid_m2_m3";
    case G5CqResultNoEapol:
        return "no_eapol";
    case G5CqResultNoBeacon:
        return "no_target_beacon";
    case G5CqResultNoM2:
        return "no_m2";
    case G5CqResultNoApNonce:
        return "no_ap_nonce";
    case G5CqResultStaMismatch:
        return "sta_mismatch";
    case G5CqResultReplayMismatch:
        return "replay_mismatch";
    case G5CqResultInvalidCrypto:
        return "invalid_nonce_or_mic";
    case G5CqResultWrongTarget:
        return "wrong_target";
    case G5CqResultMalformed:
        return "malformed";
    case G5CqResultCountMismatch:
        return "frame_count_mismatch";
    case G5CqResultCapacity:
