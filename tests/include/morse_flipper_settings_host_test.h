...
typedef struct MorseFlipperApp {
    ...
    uint8_t input_source, keyer_mode, handedness, audio_path, tone_idx, p2_volume_pct,
        preview_ticks;
...
enum {
    MorseFlipperPluginOwnerSettings = 6,
    ...
    MorseFlipperSceneHome = 13,
    MorseFlipperSceneAudioCfg = 14,
    MorseFlipperSceneTrainer = 15,
    MorseFlipperSceneStraightCfg = 16,
    MorseFlipperScenePc = 17,
    MorseFlipperSceneGpio = 19,
    MorseFlipperSceneTxGroupsCfg = 34,
    MorseFlipperSceneRxCallsignsCfg = 35
};
