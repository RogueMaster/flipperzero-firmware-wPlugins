...
TESTS = (
    ...
    CTest("radio-fal-lifecycle", ("tests/test_radio_fal_lifecycle.c", "src/firmware/plugins/radio/mf_radio_core.c", "src/firmware/morse_flipper_radio_host.c", "src/firmware/morse_flipper_run_history.c", "src/firmware/morse_flipper_cw_decoder.c", "src/firmware/morse_flipper_cw_token.c", "src/firmware/cw.c")),
    CTest("radio-fal", ("tests/test_radio_fal.c", "src/firmware/plugins/radio/mf_radio_core.c", "src/firmware/plugins/radio/mf_radio_draw.c", "src/firmware/morse_flipper_radio_host.c", "src/firmware/morse_flipper_run_history.c", "src/firmware/morse_flipper_cw_decoder.c", "src/firmware/morse_flipper_cw_token.c", "src/firmware/cw.c")),
