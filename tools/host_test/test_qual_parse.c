...
static const char kQualOk[] =
    "Qual: gga=12 ggafix=11 drop=3 net=142 sd=1 sats=8 topd=1";
...
int test_qual_parse_run(void) {
    ...
    /* zeros are a measurement, not "never seen". */
    {
        static const char kZero[] =
            "Qual: gga=0 ggafix=0 drop=0 net=0 sd=0 sats=0 topd=0";
        memset(&parser, 0, sizeof(parser));
    ...
    /* renamed field is not Qual */
    {
        static const char kBad[] =
            "Qual: ggx=12 ggafix=11 drop=3 net=142 sd=1 sats=8 topd=1";
        memset(&parser, 0, sizeof(parser));
    ...
    {
        static const char kSd[] =
            "Qual: gga=1 ggafix=1 drop=0 net=0 sd=256 sats=0 topd=0";
        memset(&parser, 0, sizeof(parser));
