...
#define NFC_TOOLS_NDEF_BUF1_SIZE NFC_TOOLS_NDEF_BUF_SIZE // URL / text / WiFi SSID / Mail To / Contact Name
#define NFC_TOOLS_NDEF_BUF2_SIZE NFC_TOOLS_NDEF_BUF_SIZE // WiFi password / Mail Subject / Contact Company
