...
public:
    bool load_char(const char *path_name, char *value, size_t value_size, const char *appId = "ghouls"); // load a string from storage
    bool save_char(const char *path_name, const char *value, const char *appId = "ghouls");              // save a string to storage
